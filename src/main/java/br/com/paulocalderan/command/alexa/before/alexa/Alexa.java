package br.com.paulocalderan.command.alexa.before.alexa;

import java.util.HashMap;
import java.util.Map;

import br.com.paulocalderan.command.alexa.before.lights.PhillipsHueLight;
import br.com.paulocalderan.command.alexa.before.lights.XiaomiLight;
